...
## **ABOUT**:
- This project is based on answering some business questions using sql queries to find the right answers.
- It is entirely written in sql.
## **BUSINESS QUESTIONS**:
...
## **RESOURCES**
- [pagila database from github.com](https://github.com/devrimgunduz/pagila) 
## **TECH STACK**:
- PostgreSql Database
- Sql
